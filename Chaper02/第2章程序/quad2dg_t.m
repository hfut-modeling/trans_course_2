function [int, tol1,k] = quad2dg_t(fun,xlow,xhigh,ylow,yhigh,tol,p1,p2,p3,p4,p5,p6,p7,p8,p9)
%    矩形区域GAUSS积分法
%    int  = quad2dg('Fun',xlow,xhigh,ylow,yhigh)
%
%       int     -- 积分值
%       Fun     -- 二元被积函数Fun(x,y)
%       xlow    --  x 下限
...
%       yhigh   --  y 上限
%
%       [int tol] = quad2dg('Fun',xlow,xhigh,ylow,yhigh)
